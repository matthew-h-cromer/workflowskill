...
export { resolveExpression, containsTemplate, resolveTemplate, stringify, LexError, ParseExprError, EvalError } from './expression/index.js';
...
export type { WorkflowSkillConfig } from './config/index.js';
export {
  dispatch,
  executeTransform,
  executeConditional,
